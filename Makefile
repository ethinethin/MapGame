...
CFILES=./src/main.c ./src/rand.c ./src/maps.c ./src/disp.c ./src/play.c ./src/loot.c ./src/font.c ./src/maus.c ./src/devm.c ./src/harv.c ./src/hold.c ./src/make.c ./src/save.c ./src/file.c
